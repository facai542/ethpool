  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-100">管理后台首页</h1>
          <p className="text-gray-400 mt-1 text-sm lg:text-base">系统概览和数据统计</p>
        </div>
        <Button onClick={fetchStats} disabled={loading} variant="outline" size="sm" className="w-fit">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 lg:gap-6">
        <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          ...
          <CardContent>
            ...
            <p className="text-xs text-blue-100">注册用户总数</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-white">已授权</CardTitle>
            <UserCheck className="h-4 w-4 text-white" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.authorizedUsers.toLocaleString()}</div>
            <p className="text-xs text-green-100">已完成授权用户</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-white">未授权</CardTitle>
            <AlertCircle className="h-4 w-4 text-white" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.unauthorizedUsers.toLocaleString()}</div>
            <p className="text-xs text-orange-100">待授权用户</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-white">质押中</CardTitle>
            <TrendingUp className="h-4 w-4 text-white" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.stakingUsers.toLocaleString()}</div>
            <p className="text-xs text-purple-100">正在质押用户</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-yellow-500 to-yellow-600 text-white">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-white">有收益</CardTitle>
            <DollarSign className="h-4 w-4 text-white" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-white">{stats.profitUsers.toLocaleString()}</div>
            <p className="text-xs text-yellow-100">有收益用户</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-base lg:text-lg">
              <TrendingUp className="h-4 w-4 lg:h-5 lg:w-5 mr-2 text-green-600" />
              挖矿收益统计
            </CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center text-base lg:text-lg">
              <Wallet className="h-4 w-4 lg:h-5 lg:w-5 mr-2 text-blue-600" />
              钱包余额统计
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 lg:space-y-4">
