...
interface FramedCardNoBottomProps {
...
export const FramedCardNoBottom: React.FC<FramedCardNoBottomProps> = ({
  children,
  className = '',
  minHeight = '400px',
      ...
      <div className="binance-frame flex" style={{ minHeight }}>
        ...
        <div className="flex flex-col w-[14px]">
          ...
          <div 
            ...
            style={{ 
              borderLeft: '1px solid rgb(252, 234, 156)',
        ...
        <div className="flex flex-col flex-1">
          ...
          {/* 卡片内容 */}
          <div className="flex-1 bg-gradient-to-br from-black/80 to-gray-900/90 backdrop-blur-sm border-l border-r border-yellow-500/20 p-4 md:p-6" style={{
            paddingBottom: '24px',
            marginBottom: '-8px'
          }}>
            {children}
        ...
        <div className="flex flex-col w-[14px]">
          ...
          <div 
            className="flex flex-1 bg-[#1E1E1E] items-center" 
            style={{ 
              borderRight: '1px solid rgb(252, 234, 156)',
              height: 'calc(100% + 16px)'
            }}
          >
            <img 
