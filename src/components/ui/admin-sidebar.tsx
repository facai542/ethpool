      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { icon: <DollarSign size={16} className="text-slate-50" />, label: "充值订单", path: "/admin/users/deposits" },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              icon: <LinkIcon size={16} className="text-slate-50" />,
              label: "网站设置",
...
export function AdminSidebar({
  ...
  return (
    <div className="fixed left-0 top-0 h-screen z-50 flex flex-row bg-slate-800">
