...
const RouteIcon = forwardRef<RouteIconHandle, RouteIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div
        className={cn("!bg-transparent !border-none !p-0 !m-0", className)}
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
        style={{ backgroundColor: 'transparent !important', border: 'none !important', padding: '0 !important', margin: '0 !important' }}
        {...props}
      >
        <svg
