...
export const SignInPage = ({ 
  ...
  onCodeSubmit,
  onSuccess,
  customEmailPlaceholder = "info@gmail.com",
  customTitle = "Welcome Developer",
  customSubtitle = "Your sign in component",
  showNavbar = true,
      ...
      if (index === 5 && value) {
        ...
        if (isComplete) {
          ...
          setTimeout(async () => {
            setStep("success");
            if (onCodeSubmit) {
              await onCodeSubmit(newCode.join(''));
            }
            if (onSuccess) {
              onSuccess();
            }
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">{customTitle}</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">{customSubtitle}</p>
                    </div>
